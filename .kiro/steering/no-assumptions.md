...
### 5. NO UNSOLICITED FILE CREATION:

**RULE:** Never create new `.md`, summary, or documentation files without explicit user permission.

✅ **Good (ask first):**
"I can create a `summary.md` for this. Should I?"
