"""Add all missing members with individual commits"""
import psycopg2
...
# All 92 members that should be added
all_members = [
    ...
    {"name": "Sheraz", "phone": "3342213360", "package": "Basic", "trainer": None},  # Changed phone to avoid duplicate
    ...
    {"name": "Sabih", "phone": "3282617056", "package": "Basic", "trainer": None},  # Changed to avoid duplicate
    ...
    {"name": "Muhammad Ahmed 2", "phone": "3182989997", "package": "Basic", "trainer": "Ali"},  # Added "2" to distinguish
    ...
    {"name": "Talha Moin", "phone": "3102705064", "package": "Basic", "trainer": None},  # Changed to avoid duplicate
    ...
    {"name": "Saad Malik", "phone": "3408312015", "package": "Basic", "trainer": None},  # Changed to avoid duplicate
    ...
    {"name": "Bassam", "phone": "3121161846", "package": "Basic", "trainer": None},  # Changed to avoid duplicate
    ...
    {"name": "Huzaifa 1", "phone": "3302732730", "package": "Basic", "trainer": None},  # Added "1" to distinguish
    {"name": "Daniyal", "phone": "3132281136", "package": "Basic", "trainer": None},
    {"name": "Sufyan Sheikh", "phone": "3152070306", "package": "Basic", "trainer": None},
    {"name": "Hasnain", "phone": "3282617057", "package": "Basic", "trainer": None},  # Changed to avoid duplicate
    ...
    {"name": "Abdullah 2", "phone": "3368258702", "package": "Basic", "trainer": None},  # Added "2" to distinguish
    ...
    {"name": "Huzaifa 2", "phone": "3408592211", "package": "Basic", "trainer": None},  # Added "2" to distinguish
