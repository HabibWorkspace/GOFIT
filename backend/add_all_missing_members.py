"""
Add all 92 missing members to production database
"""
import psycopg2
    ...
    try:
        ...
        for member in all_members:
            try:
                ...
                trainer_str = f" (Trainer: {member['trainer']})" if member['trainer'] else ""
                print(f"  ✓ Added {member['name']} - {member['package']}{trainer_str}")
                added += 1
