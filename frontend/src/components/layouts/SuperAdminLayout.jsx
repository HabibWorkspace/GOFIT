...
export default function SuperAdminLayout({ children }) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: '/super-admin/live-attendance',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      path: '/super-admin/trainers/commissions',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Members Report',
      path: '/super-admin/members-report',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen bg-fitnix-dark">
      ...
      <aside
        ...
        } bg-gradient-to-b from-fitnix-dark via-fitnix-dark-light to-fitnix-dark border-r border-fitnix-gold/20 w-64`}
      >
        <div className="h-full flex flex-col">
          <div className="flex-1 px-3 py-4 overflow-y-auto">
            {/* Logo */}
            <div className="flex items-center justify-center mb-8 pb-4 border-b border-fitnix-gold/20">
          ...
          <div className="p-4 border-t border-fitnix-gold/20 bg-fitnix-dark">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-semibold text-fitnix-off-white">{user?.username}</p>
            ...
            <button
              ...
              className="w-full bg-red-900/20 hover:bg-red-900/30 border border-red-500/30 text-red-400 px-4 py-2 rounded-lg transition-all flex items-center justify-center"
            >
      ...
      <div className={`${sidebarOpen ? 'ml-64' : 'ml-0'} transition-all`}>
        {/* Top Bar */}
        <div className="bg-gradient-to-r from-fitnix-dark via-fitnix-dark-light to-fitnix-dark border-b border-fitnix-gold/20 px-6 py-4">
          <div className="flex items-center justify-between">
            <button
              onClick={() => setSidebarOpen(!sidebarOpen)}
              className="text-fitnix-off-white hover:text-fitnix-gold transition-colors"
            >
            ...
            <div className="flex items-center space-x-4">
              <span className="text-fitnix-off-white/60 text-sm">
